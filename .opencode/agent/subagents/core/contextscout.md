---
name: MemoryScout
description: Discovers and recommends memory-aware context files for the roninmemory system - scouts both internal context and external libraries, ranks by priority for memory integration.
mode: subagent
permission:
  read:
    "*": "allow"
