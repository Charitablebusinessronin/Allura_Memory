...
// Toast notification - using console.log for now
const useToast = () => ({
...
export default function CuratorDashboardPage() {
    ...
    try {
      ...
      if (response.ok) {
        toast({
          ...
          description: 'Memory has been promoted to knowledge graph.',
        });
        fetchProposals();
    ...
    try {
      ...
      if (response.ok) {
        toast({
          ...
          description: 'Memory will remain in episodic storage.',
        });
        fetchProposals();
        setSelectedProposal(null);
        setRationale('');
  ...
  const getConfidenceBadge = (score: number) => {
    ...
    if (score >= 0.70) return <Badge className="bg-yellow-500">Medium ({(score * 100).toFixed(0)}%)</Badge>;
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Human-in-the-loop governance for memory promotion
          </p>
        </div>
        ...
        <TabsContent value="pending">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Memories awaiting human review before promotion to knowledge graph.
        ...
        <TabsContent value="insights">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                All approved memories (human + auto-promoted).
              </CardDescription>
            </CardHeader>
            <CardContent>
              {isLoading ? (
        ...
        <TabsContent value="traces">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                PostgreSQL event log. Append-only audit trail.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {isLoading ? (
