...
const DEFAULT_CONFIG: EncodingValidatorConfig = {
  ...
  skipPatterns: [/node_modules/, /\.git/, /dist/, /build/, /\.next/, /coverage/],
}
 ...
 */
export function createEncodingValidator(config?: Partial<EncodingValidatorConfig>): EncodingValidator {
