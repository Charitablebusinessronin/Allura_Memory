...
| `NOTION_INSIGHTS_DATABASE_ID` | Notion database ID | `e5d3db1e-1290-4d33-bd1f-71f93cc36655` (Master Knowledge Base) |

### Notion Integration

The Notion integration is now fully operational. The Curator Agent successfully promotes insights from Neo4j to Notion for human approval.

**Verified Working:**
- ✅ Direct Notion API client (`src/lib/notion/client.ts`)
- ✅ Property mapping (Curator schema → Master Knowledge Base schema)
- ✅ Page creation in Master Knowledge Base
- ✅ Real token and database ID configured

**Master Knowledge Base Schema:**
- `Name` (title) - Page title
- `Category` (select) - Insight category
- `Tags` (multi_select) - Display tags
- `Source` (rich_text) - Source project
- `Content Type` (select) - Document type
- `AI Accessible` (checkbox) - Approval flag
...
[Curator] Promotion run complete. Processed N insights. K promoted
```
