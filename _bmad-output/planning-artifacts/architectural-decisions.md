# Architectural Decisions — Allura Agent-OS
...
Promoted from archive `roninmemory/RISKS-AND-DECISIONS.md`. Updated to Allura v2 naming. All AD-01 to AD-16 decisions are `✅ Decided`. All RK-01 to RK-10 risks are documented with mitigations.
...
| **References** | `src/curator/`, `RK-01`, `RK-02` |
...
| **References** | `AD-16`, `tenant-memory-boundary-spec.md` §4 |
...
| **References** | `data-dictionary.md` — `notion_sync_log`, `RK-03` |
...
| **References** | `AD-16`, `data-dictionary.md` |
...
| **References** | `CLAUDE.md`, `prd-v2.md` §5 |
...
| **Mitigation** | Async queue with exponential backoff. Mirror is non-fatal (AD-04) — promotion proceeds regardless. Failed syncs logged to `notion_sync_log` and backfilled. |
...
| **Mitigation** | Human reviewer evaluates quality during Aegis sign-off (AD-09). Diverse ground-truth test cases reduce the probability of gaming. |
| **Related decision** | AD-09 |
...
- [`_bmad-output/implementation-artifacts/data-dictionary.md`](_bmad-output/implementation-artifacts/data-dictionary.md) — schema definitions
